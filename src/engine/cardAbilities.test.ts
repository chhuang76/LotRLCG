 ...
 *
 * Tests the shared ability machinery and the player cards that still live in
 * `cardAbilities.ts`. Per-card modules under `src/engine/cards/**` have their
 * own colocated tests.
 */

import { describe, it, expect, beforeEach } from 'vitest';
import type { PlayerCard } from './types';
// Side-effect import: registers all per-card ability modules (Aragorn, Gimli, Legolas, ...).
import './cards';
import {
    getAbilities,
    hasAbilities,
