...
const PLAYER_DECK: PlayerCard[] = [
  ...
  {
    code: '01028', name: 'Sneak Attack', type_code: 'event', sphere_code: 'leadership',
    cost: 1, traits: '',
  ...
  {
    code: '01042', name: 'Swift Strike', type_code: 'event', sphere_code: 'tactics',
    cost: 0, traits: '',
    text: '<b>Action:</b> Deal 2 damage to an enemy currently engaged with you.',
    quantity: 3,
  },
  {
    code: '01044', name: 'Blade of Gondolin', type_code: 'attachment', sphere_code: 'tactics',
    cost: 1, traits: 'Item. Weapon.',
    text: 'Attach to a hero. Attached hero gets +1 [attack].<br/><b>Response:</b> After attached hero participates in an attack that destroys an Orc or Goblin enemy, place 1 progress token on the current quest.',
    quantity: 3,
  },
  {
    code: '01061', name: 'Gandalf', type_code: 'ally', sphere_code: 'neutral',
    cost: 5, willpower: 4, attack: 4, defense: 4, health: 4,
    traits: 'Istari.',
    text: '<b>Forced:</b> At the end of the round, discard Gandalf from play.<br/><b>Action:</b> When Gandalf enters play choose one: draw 3 cards, deal 4 damage to 1 enemy in play, or reduce your threat by 5.',
    quantity: 3,
  },
];
